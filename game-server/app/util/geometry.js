 ...
 * @param polygon {Array} Test polygon, the polygon is an array of point, by the order on polygon
 * @return {Boolean}
 * @api public
 */
 ...
 * @param p2 {Object} Line's another end point
 ...
 *
 * @param p1 An end point of the first line
 * @param p2 Another end point of the first line
 * @param q1 An end point of the second line
 * @param q2 Another end point of the second line
 * @returns {boolean}
 */
 ...
 * @param q1 {Object} The point with the smallest x and y in rect2
 * @param q2 {Object} The point with the biggest x and y in rect2
 * @returns {boolean} If the two rectangle is intersect
 * @api public
 */
